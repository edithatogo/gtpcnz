...
Urgent care and ambulance interactions remain part of the upstream architecture discussion, but v1.8.1 does not convert them into measured substitution claims.

**Claim boundary:** Do not claim ambulance demand, ED demand, or urgent-care substitution effects. These remain out of scope until specific public validation gates are passed.
