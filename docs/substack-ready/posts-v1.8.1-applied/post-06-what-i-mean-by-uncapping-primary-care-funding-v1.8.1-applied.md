...
The v1.8.1 evidence lane reinforces that "uncapping" must mean scheduled, audited, place-accountable, and claim-gated funding. It is not an open-ended spending claim.

**Claim boundary:** Do not claim uncapping will produce precise savings, hospital deflection, or workforce effects. The supported claim is about the plausibility of a bounded architecture for public testing.
