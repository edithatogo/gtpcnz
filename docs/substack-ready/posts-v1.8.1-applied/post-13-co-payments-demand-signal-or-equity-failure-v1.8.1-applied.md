...
Public aggregate cost-barrier evidence is now part of the calibration and validation surface. This supports treating co-payments as both a demand signal and an equity-risk mechanism.

**Claim boundary:** Do not claim a specific co-payment reform will produce measured access, equity, fiscal, or hospital outcomes. The evidence status supports risk framing and validation priorities.
