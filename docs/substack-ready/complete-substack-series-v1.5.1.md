# Complete short-form Substack series v1.5.1
...
**Deep dive:** I’ve kept the fuller explanation, game table, modelling notes and full source list in the [appendix for this post](appendices-v1.5.1/appendix-01-are-we-buying-hospital-growth-by-rationing-cheaper-care-upstream-v1.5.1.md).
...
**Deep dive:** I’ve kept the fuller explanation, game table, modelling notes and full source list in the [appendix for this post](appendices-v1.5.1/appendix-03-marginal-supply-the-tiny-economic-idea-that-decides-whether-appointments-exist-v1.5.1.md).
...
**Deep dive:** I’ve kept the fuller explanation, game table, modelling notes and full source list in the [appendix for this post](appendices-v1.5.1/appendix-05-the-current-reform-pathway-stronger-than-a-straw-man-but-maybe-still-incomplete-v1.5.1.md).
...
**Deep dive:** I’ve kept the fuller explanation, game table, modelling notes and full source list in the [appendix for this post](appendices-v1.5.1/appendix-06-what-i-mean-by-uncapping-primary-care-funding-v1.5.1.md).
...
**Deep dive:** I’ve kept the fuller explanation, game table, modelling notes and full source list in the [appendix for this post](appendices-v1.5.1/appendix-07-the-hospital-salience-game-and-the-health-new-zealand-allocation-game-v1.5.1.md).
...
**Deep dive:** I’ve kept the fuller explanation, game table, modelling notes and full source list in the [appendix for this post](appendices-v1.5.1/appendix-08-the-capitation-marginal-supply-game-and-the-consumer-access-game-v1.5.1.md).
...
**Deep dive:** I’ve kept the fuller explanation, game table, modelling notes and full source list in the [appendix for this post](appendices-v1.5.1/appendix-09-primary-health-organisations-useful-functions-payment-friction-and-cherry-picking-v1.5.1.md).
...
**Deep dive:** I’ve kept the fuller explanation, game table, modelling notes and full source list in the [appendix for this post](appendices-v1.5.1/appendix-10-accident-compensation-corporation-ambulance-and-urgent-care-the-hidden-upstream-system-v1.5.1.md).
...
**Deep dive:** I’ve kept the fuller explanation, game table, modelling notes and full source list in the [appendix for this post](appendices-v1.5.1/appendix-11-who-should-be-allowed-to-generate-primary-care-supply-v1.5.1.md).
...
**Deep dive:** I’ve kept the fuller explanation, game table, modelling notes and full source list in the [appendix for this post](appendices-v1.5.1/appendix-13-co-payments-demand-signal-or-equity-failure-v1.5.1.md).
...
**Deep dive:** I’ve kept the fuller explanation, game table, modelling notes and full source list in the [appendix for this post](appendices-v1.5.1/appendix-14-the-19-games-a-map-of-the-new-zealand-primary-care-funding-problem-v1.5.1.md).
...
**Deep dive:** I’ve kept the fuller explanation, game table, modelling notes and full source list in the [appendix for this post](appendices-v1.5.1/appendix-15-the-hybrid-game-why-no-single-lever-is-enough-v1.5.1.md).
...
**Deep dive:** I’ve kept the fuller explanation, game table, modelling notes and full source list in the [appendix for this post](appendices-v1.5.1/appendix-17-game-informed-multi-criteria-decision-analysis-making-disagreement-useful-v1.5.1.md).
