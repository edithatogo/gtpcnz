...
**Red-team check:** Current reforms may already improve this problem. This post is not saying nothing is happening. It asks whether the reforms change the upstream supply game enough, or whether hospital demand still becomes the visible pressure valve.
...
**Deep dive (optional, not required reading):** I’ve kept the fuller explanation, game table, modelling notes and full source list in the [appendix for this post](../appendices-v1.7.2/appendix-01-are-we-buying-hospital-growth-by-rationing-cheaper-care-upstream-v1.7.2.md).
