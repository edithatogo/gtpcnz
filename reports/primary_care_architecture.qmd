...
This report summarises a source-informed scaffold for thinking about primary care funding architecture in Aotearoa New Zealand.
...
The proposed architecture is a hybrid:
...
3. **Place-based accountability** to protect comprehensive population responsibility and reduce cherry-picking.
4. **Item rules, clinical governance, documentation, audit and data visibility** to reduce gaming and low-value activity.
...
This report is a public explanation of a model scaffold. It can be used to compare policy logics, identify assumptions and guide stakeholder validation.
...
For the formal model boundary, see the model card and claim-boundary documents rendered on this site.

# 2. The current reform pathway is the comparator

**Source-confidence label: public document + policy interpretation.**

A weak critique would pretend New Zealand is doing nothing. That is not the argument here.

The current reform pathway includes capitation reweighting, a primary care access target, the National Primary Care Dataset, digital access work, urgent and after-hours care, Primary Health Organisation accountability work and separate appropriation structures.

The real question is whether that pathway changes the supply game enough.
...
Capitation pays a fixed amount for an enrolled person or population. It can support continuity and population responsibility. It can also help with budget predictability.
...
The proposal is not uncontrolled billing.
...
The Accident Compensation Corporation analogy is useful because it already uses rules-based treatment payments, provider eligibility, contracts and regulation. It is not a complete template for illness-based primary care.

# 5. Why place-based accountability matters

**Source-confidence label: red-team finding + policy judgement.**

A fee-for-service stream can improve marginal supply, but it can also create cherry-picking. Providers may select easier, shorter or more profitable contacts unless the system also protects hard-to-reach populations, rural communities, complex patients and people with high unmet need.

That is why place-based accountability is not optional. A national benefit schedule should sit alongside responsibility for whole populations.
...
The scaffold suggests four patterns:
...
4. The strongest scenario is the full hybrid: capitation, scheduled fee-for-service, place accountability, urgent/ambulance alternatives, scope-enabled supply, data, audit and key performance indicators.

# 8. What would change my mind

**Source-confidence label: falsification framework.**

This argument would be weaker if evidence showed that:
...
The next step is not to make the scaffold more complicated. It is to validate the load-bearing assumptions:
...
The strongest policy question is not whether capitation or fee-for-service is morally superior. It is whether the funding architecture allows safe upstream care to expand before unmet need becomes hospital demand.
