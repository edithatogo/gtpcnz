...
- `051-dashboard-ui-methodology-completion_20260530`: Wires all remaining Track 049 backend functions into Streamlit UI: methodology/evidence tab, animated plots, clustering display, composite meta-plot, Substack cross-refs, evidence downloads. Created pending implementation.
- `052-dashboard-lab-enhancements-deep-dive_20260530`: Adds "How this works" documentation expanders to microeconomics and game theory labs, combined/hybrid models, outcome clustering, table filters, cross-reference links. Created pending implementation.
