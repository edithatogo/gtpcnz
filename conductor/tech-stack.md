...
- PySD or custom Python implementation for system dynamics.
- SALib for sensitivity analysis.
- Jupyter notebooks for exploratory model calibration.
- Mermaid diagrams for causal loop and system maps.
