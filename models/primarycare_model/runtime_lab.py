...
SUBSTACK_POSTS = {
    "01": {"title": "Are we buying hospital growth by rationing cheaper care upstream?",
            "url": "https://rareinsights.substack.com/p/are-we-buying-hospital-growth-by",
            "file": "docs/substack-ready/posts-v1.8.1-applied/post-01-are-we-buying-hospital-growth-by-rationing-cheaper-care-upstream-v1.8.1-applied.md",
            "models": ["Reference scenarios", "F0-F9 comparison"]},
    "02": {"title": "Fee-for-service, capitation and blended funding",
            "url": "https://rareinsights.substack.com/p/fee-for-service-capitation-and-blended-funding-the-plain-english-version",
            "file": "docs/substack-ready/posts-v1.8.1-applied/post-02-fee-for-service-capitation-and-blended-funding-the-plain-english-version-v1.8.1-applied.md",
            "models": ["Funding model comparison", "Educational explainer"]},
    "03": {"title": "Marginal supply",
            "url": "https://rareinsights.substack.com/p/marginal-supply-the-tiny-economic-idea-that-decides-whether-appointments-exist",
            "file": "docs/substack-ready/posts-v1.8.1-applied/post-03-marginal-supply-the-tiny-economic-idea-that-decides-whether-appointments-exist-v1.8.1-applied.md",
            "models": ["Microeconomics lab 1", "Supply generation"]},
    "04": {"title": "Why formulas do not solve games",
            "url": "https://rareinsights.substack.com/p/why-formulas-do-not-solve-games",
            "file": "docs/substack-ready/posts-v1.8.1-applied/post-04-why-formulas-do-not-solve-games-v1.8.1-applied.md",
            "models": ["Game theory labs", "Gaming risk"]},
    "05": {"title": "Current reform pathway",
            "url": "https://rareinsights.substack.com/p/the-current-reform-pathway-stronger-than-a-straw-man-but-maybe-still-incomplete",
            "file": "docs/substack-ready/posts-v1.8.1-applied/post-05-the-current-reform-pathway-stronger-than-a-straw-man-but-maybe-still-incomplete-v1.8.1-applied.md",
            "models": ["Reference scenario F0"]},
    "06": {"title": "What I mean by uncapping primary care funding",
            "url": "https://rareinsights.substack.com/p/what-i-mean-by-uncapping-primary-care-funding",
            "file": "docs/substack-ready/posts-v1.8.1-applied/post-06-what-i-mean-by-uncapping-primary-care-funding-v1.8.1-applied.md",
            "models": ["Microeconomics lab 3", "Scheduled payment"]},
    "07": {"title": "The hospital salience game and the Health New Zealand allocation game",
            "url": "https://rareinsights.substack.com/p/the-hospital-salience-game-and-the-health-new-zealand-allocation-game",
            "file": "docs/substack-ready/posts-v1.8.1-applied/post-07-the-hospital-salience-game-and-the-health-new-zealand-allocation-game-v1.8.1-applied.md",
            "models": ["Hospital salience", "Allocation-priority explainer"]},
    "08": {"title": "The capitation marginal-supply game and the consumer access game",
            "url": "https://rareinsights.substack.com/p/the-capitation-marginal-supply-game-and-the-consumer-access-game",
            "file": "docs/substack-ready/posts-v1.8.1-applied/post-08-the-capitation-marginal-supply-game-and-the-consumer-access-game-v1.8.1-applied.md",
            "models": ["Microeconomics lab", "Marginal supply simulation"]},
    "09": {"title": "Primary Health Organisations: useful functions, payment friction and cherry-picking",
            "url": "https://rareinsights.substack.com/p/primary-health-organisations-useful-functions-payment-friction-and-cherry-picking",
            "file": "docs/substack-ready/posts-v1.8.1-applied/post-09-primary-health-organisations-useful-functions-payment-friction-and-cherry-picking-v1.8.1-applied.md",
            "models": ["Game theory lab", "Gaming-risk frontier"]},
    "10": {"title": "Accident Compensation Corporation, ambulance and urgent care: the hidden upstream system",
            "url": "https://rareinsights.substack.com/p/accident-compensation-corporation-ambulance-and-urgent-care-the-hidden-upstream-system",
            "file": "docs/substack-ready/posts-v1.8.1-applied/post-10-accident-compensation-corporation-ambulance-and-urgent-care-the-hidden-upstream-system-v1.8.1-applied.md",
            "models": ["Reference scenarios", "Pathway stress explanation"]},
    "11": {"title": "Who should be allowed to generate primary care supply?",
            "url": "https://rareinsights.substack.com/p/who-should-be-allowed-to-generate-primary-care-supply",
            "file": "docs/substack-ready/posts-v1.8.1-applied/post-11-who-should-be-allowed-to-generate-primary-care-supply-v1.8.1-applied.md",
            "models": ["Scope capacity", "Educational explainer"]},
    "12": {"title": "Telehealth is an extender, not a replacement for local supply",
            "url": "https://rareinsights.substack.com/p/telehealth-is-an-extender-not-a-replacement-for-local-supply",
            "file": "docs/substack-ready/posts-v1.8.1-applied/post-12-telehealth-is-an-extender-not-a-replacement-for-local-supply-v1.8.1-applied.md",
            "models": ["Local supply", "Digital extender explanation"]},
    "13": {"title": "Co-payments: demand signal or equity failure?",
            "url": "https://rareinsights.substack.com/p/co-payments-demand-signal-or-equity-failure",
            "file": "docs/substack-ready/posts-v1.8.1-applied/post-13-co-payments-demand-signal-or-equity-failure-v1.8.1-applied.md",
            "models": ["Co-payment barrier module", "Equity protection"]},
    "14": {"title": "The 19 games: a map of the New Zealand primary care funding problem",
            "url": "https://rareinsights.substack.com/p/the-19-games-a-map-of-the-new-zealand-primary-care-funding-problem",
            "file": "docs/substack-ready/posts-v1.8.1-applied/post-14-the-19-games-a-map-of-the-new-zealand-primary-care-funding-problem-v1.8.1-applied.md",
            "models": ["Game map navigator", "Model gap map"]},
    "15": {"title": "The hybrid game: why no single lever is enough",
            "url": "https://rareinsights.substack.com/p/the-hybrid-game-why-no-single-lever-is-enough",
            "file": "docs/substack-ready/posts-v1.8.1-applied/post-15-the-hybrid-game-why-no-single-lever-is-enough-v1.8.1-applied.md",
            "models": ["Scenario profile", "Hybrid viability decomposition"]},
    "16": {"title": "Composite modelling: what the demonstrative model adds, and what it does not",
            "url": "https://rareinsights.substack.com/p/composite-modelling-what-the-demonstrative-model-adds-and-what-it-does-not",
            "file": "docs/substack-ready/posts-v1.8.1-applied/post-16-composite-modelling-what-the-demonstrative-model-adds-and-what-it-does-not-v1.8.1-applied.md",
            "models": ["Live model lab", "Uncertainty and model gap map"]},
    "17": {"title": "Game-informed Multi-Criteria Decision Analysis: making disagreement useful",
            "url": "https://rareinsights.substack.com/p/game-informed-multi-criteria-decision-analysis-making-disagreement-useful",
            "file": "docs/substack-ready/posts-v1.8.1-applied/post-17-game-informed-multi-criteria-decision-analysis-making-disagreement-useful-v1.8.1-applied.md",
            "models": ["Value of information", "Decision support"]},
    "18": {"title": "Recommendations: a primary care system that can grow before hospitals have to",
            "url": "https://rareinsights.substack.com/p/recommendations-a-primary-care-system-that-can-grow-before-hospitals-have-to",
            "file": "docs/substack-ready/posts-v1.8.1-applied/post-18-recommendations-a-primary-care-system-that-can-grow-before-hospitals-have-to-v1.8.1-applied.md",
            "models": ["Recommendations", "Release model card"]},
}
