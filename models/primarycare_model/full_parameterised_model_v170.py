"""Public-data calibrated parameterisation framework for the primary care
funding architecture model, v1.7.0.

This module moves the project from a small source-informed parameterised model to a
fully specified parameterisation framework. The live benchmark is calibrated to
public aggregate evidence and should not be treated as an individual-level or
...
PARAMETER_SPECS: tuple[ParameterSpec, ...] = (
    ...
    ParameterSpec("G06", "data_observability_hospital", "data", "Visibility and linkage of ED/admission outcomes to upstream access.", "0-1 index", 0.60, 0.00, 0.95, "source-informed prior", "Hospital data collections exist", "ED/NMDS governed identifier linkage", "Linked outcomes model", "high"),
    ...
    ParameterSpec("H02", "ed_conversion_rate", "hospital", "Rate at which unmet primary care need converts to ED presentation.", "0-1 index", 0.32, 0.01, 0.90, "placeholder prior", "Needs governed record linkage", "Unmet care/waiting time to ED", "Hazard/transition model", "high"),
...
DATA_INPUT_SPECS: tuple[DataInputSpec, ...] = (
    DataInputSpec("I01", "ncpd_appointments", "person-practice-month", "governed health identifier, practice_id, booked_date, seen_date, mode, urgency, provider_type, outcome", "Estimate access, wait time, demand, provider-scope activity and unmet need proxies", "National Primary Care Dataset", "Health NZ data access framework / research agreement", "High"),
    DataInputSpec("I02", "primary_encounters", "person-practice-encounter", "governed health identifier, date, reason/contact_type, provider_type, mode, diagnosis/proxy, outcome", "Estimate contact demand, provider type substitution, follow-up and safety", "NPCD / practice management systems", "Health NZ/research agreement/practice collaboration", "High"),
    ...
    DataInputSpec("I06", "ambulance_events", "event", "governed health identifier if available, time, acuity, response, disposition, conveyance, handover delay, funding source", "Estimate conveyance/default, deflection and ambulance-hospital interface", "Ambulance providers/HNZ/ACC", "Data-sharing/OIA/ethics", "High"),
    DataInputSpec("I07", "ed_and_hospital_linkage", "person-event", "governed health identifier, ED arrival, triage, diagnosis, disposition, admission, LOS, cost weight", "Estimate ED/admission conversion and hospital pressure", "NNPAC/NMDS/HNZ", "Health data access/ethics", "High"),
    ...
    DataInputSpec("I10", "equity_and_consumer_experience", "person/group", "ethnicity, NZDep, rurality, age, sex, multimorbidity, unmet need, trust/experience", "Estimate equity modifiers, price response and trust legitimacy", "NZ Health Survey/NES/NPCD/community survey", "Public aggregate evidence + governed linkage + survey", "High"),
